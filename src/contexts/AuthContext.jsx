...
export function AuthProvider({ children }) {
  ...
  const refreshToken = async () => {
    ...
    const clientId = import.meta.env.VITE_XERO_CLIENT_ID || '6B959FB316CE4F5A8A7DC2BDCF5007F3';
    const clientSecret = import.meta.env.VITE_XERO_CLIENT_SECRET || 'hRMrh5ZvDN1S2QwxaxIKBoiYkP4qo5fIcLJJFxv9UfgQwTpz';
